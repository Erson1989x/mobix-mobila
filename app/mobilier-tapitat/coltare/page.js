...
const Coltare = () => {
  ...
  const totalPages = getNumberOfPages(coltareProducts, productsPerPage);
  ...
  const productsToDisplay = useMemo(() => {
    ...
    return coltareProducts.slice(startIndex, endIndex);
