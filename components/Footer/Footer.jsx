...
const Footer = () => {
  return (
   <footer className="bg-gray-100 w-fill h-fill p-10">
    ...
    <hr className='w-40 h-1 bg-black rounded-full md:border-b-0 md:border-l md:border-solid md:border-black md:transform md:rotate-90' />
