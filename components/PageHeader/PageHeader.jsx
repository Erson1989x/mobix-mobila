...
const PageHeader = () => {
  ...
  return (
    ...
    <div className="absolute h-[130px] top-[300px] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-72 sm:w-3/4 bg-slate-50 bg-opacity-10 flex flex-col items-center justify-center after:content-[''] after:absolute after:top-0 after:left-0 after:w-full after:h-full after:bg-gradient-radial after:from-white after:via-gray-300 after:to-transparent after:opacity-30 after:animate-pulse after:duration-3000 after:inset-0 md:h-[220px] md:top-[285px] lg:h-[255px] lg:top-[300px] xl:h-[315px] xl:top-[350px]"></div>
