...
export const cuiereProducts = [
    ...
    },
    {
        ...
        description: "Holul de la intrarea unei case este acel spaţiu pe care îl vedem în prim plan atunci când intrăm sau plecăm de acasă, tot în hol întâlnim şi petrecem oaspeţii \n Tocmai din acest motiv acest spaţiu trebuie gândit şi decorat pe măsură, acesta fiind cartea de vizită a intregii locuinţe \n Fiind considerat zona de tranzit, piesele de mobilier trebuie alese în aşa fel încât acesta să nu fie aglomerat, să fie funcţional şi modern.",
        price: 870.00,
        dimensiuni: {
            latime: 101,
            inaltime: 205,
