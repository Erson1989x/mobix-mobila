...
export const birouProducts = [

    {
        ...
        description: "Biroul Geneva este un birou perfect atât pentru adulți, cât și pentru elevi si studenti. Biroul este compact, are un sertar și două rafturi în spatele ușii.",
        price: 350.00,
        dimensiuni: {
            adancime: 60,
            inaltime: 75.5,
    ...
    },
    {
        ...
        description: "Masa de birou Nepo BIU120 este o alegere excelentă pentru cei care apreciază stilul și funcționalitatea. Masa este echipată cu un sertar și există o ușă convenabilă pentru depozitarea diverselor articole. Material PAL de inalta calitate",
        price: 560.00,
        dimensiuni: {
            adancime: 59,
            inaltime: 76,
    ...
    },
    {
        ...
        name: "Birou Nepo 150",
        images: [birouNepo150],
        description: "Masa de birou Nepo BIU150 este ideal pentru lucru sau studiu. Are un design elegant cu un stil modern. Masa are doua sertare si este prevazuta cu doua usi in care poti depozita lucruri suplimentare. Material PAL de inalta calitate. Accesorii role si balamale de marca",
        price: 810.00,
        dimensiuni: {
            adancime: 59,
            inaltime: 76,
